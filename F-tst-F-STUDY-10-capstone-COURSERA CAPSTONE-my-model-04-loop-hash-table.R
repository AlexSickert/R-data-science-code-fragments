...
MAIN_LOOP <- function(){
  ...
  for(loopCount in 1:numberOfLoops){
    ...
    #print(paste("sample() took time:", time.taken, sep=" "))
    ...
    #end.time <- Sys.time()
    #time.taken <- end.time - start.time
    #print(paste("makeCorpus() took time:", time.taken, sep=" "))
    ...
    #end.time <- Sys.time()
    #time.taken <- end.time - start.time
    #print(paste("makeFrequencyLists() took time:", time.taken, sep=" "))
    ...
    #end.time <- Sys.time()
    #time.taken <- end.time - start.time
    #print(paste("fillPredictionTables() took time:", time.taken, sep=" "))
